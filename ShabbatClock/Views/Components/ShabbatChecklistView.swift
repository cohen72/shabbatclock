    ...
    private var checklistCard: some View {
        VStack(spacing: 0) {
            ...
            checklistRow(
                ...
                title: "Alarms reviewed",
                subtitle: upcomingAlarms.isEmpty
                    ? "No alarms set for the next 48 hours."
                    : "\(upcomingAlarms.count) alarm\(upcomingAlarms.count == 1 ? "" : "s") set for the next 48 hours."
            )
        }
